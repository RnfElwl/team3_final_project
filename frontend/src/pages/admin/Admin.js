...
//   const [month_date, setMonth_date]=useState('');

//   useEffect(()=>{
//     const fetchData=async()=>{
//     try{
//       const res=await axios.get(`http://localhost:9988/admin/qna_dashboard/${month_date}`,{
  ...
  return (
      <div className="adminBody">
        ...
        <div className="adminDashboard">
          <div id='chartarea'>
          <select>
              <option name="month_date" value='9'>9월</option>
              <option name="month_date" value='10'>10월</option>
            </select>
